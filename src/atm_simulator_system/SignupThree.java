...
public class SignupThree extends JFrame implements ActionListener {
    ...
    SignupThree(String formno){
        ...
        r1 = new JRadioButton("Saving Acoount");
        ...
        add(r2);
          ...
          r3 = new JRadioButton("Current Acoount");
        r3.setFont(new Font("Raleway",Font.BOLD, 16));
        r3.setBackground(Color.WHITE);
        r3.setBounds(100, 220, 160, 20);
        add(r3);
        
          r4 = new JRadioButton("Recurring Acoount");
       ...
       number.setFont(new Font("Raleway", Font.BOLD, 22));
        ...
        add(number);
         ...
         JLabel numberdet = new JLabel("Your 16 digit Card Number");
       numberdet.setFont(new Font("Raleway", Font.BOLD, 12));
        numberdet.setBounds (100,330,300,15);
        add(numberdet);
