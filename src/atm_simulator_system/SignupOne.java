...
public class SignupOne extends JFrame implements ActionListener{
    ...
    SignupOne(){
       ...
       random = Math.abs((ran.nextLong() % 9000L) + 1000L); // assigns value to class-level variable
    ...
    public void actionPerformed(ActionEvent ae){
        String formno = "" + random;// long convert to sting
         ...
         String address = addressTextField.getText();
          String city = cityTextField.getText();
           String state = stateTextField.getText();
            ...
            try {
                if (name.equals("")){
                    JOptionPane.showMessageDialog(null, "Name is required.");//shows message if empty field
